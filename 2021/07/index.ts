// Recursive
export default function contains(store: object | string, product: string): boolean {
    // Base case
...
// Iterative
export function containsIterative(store: object | string, product: string): boolean {
